...
public class Girokonto {
    ...
    public Girokonto(int balance, int interest) {
    ...
    public int getWithdrawalmoney() {return withdrawalmoney;}

    public void setWithdrawalmoney(int withdrawalmoney) {this.withdrawalmoney = withdrawalmoney;}
}